...
Route::group(['prefix' => 'admin/comments', 'middleware' => 'role:admin'], function () {
    ...
    Route::get('/getPosts', [AdminCommentController::class, 'getPosts'])->name('getPosts');
...
Route::group(['prefix'=>'course'],function (){
    ...
    Route::get('/lesson_detail/{course}/{lesson}',[CourseController::class,'lessonDetail'])->name('lesson_detail');
});
